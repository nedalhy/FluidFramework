...
import {
  IColumns, IDataGetterParameter, IInspectorSearchCallback, IInspectorSearchControls,
  IInspectorSearchMatch, IInspectorSearchMatchMap, IInspectorTableProps,
  IInspectorTableState, IRowData, IToTableRowsOptions, SearchResult,
...
class InspectorTable<
  ...
  private readonly handleExpandAll = ({ data }) => {
    if (data) {
      ...
      // @TODO: if props.fillExpanded is not not provided, this traversal should be skipped.
