...
const Uint32Property = require('./properties/uintProperties').Uint32Property;
const StringProperty = require('./properties/stringProperty');
const Float32Property = require('./properties/floatProperties').Float32Property;
const Int32Property = require('./properties/intProperties').Int32Property;
...
const Float64Property = require('./properties/floatProperties').Float64Property;
const Uint16Property = require('./properties/uintProperties').Uint16Property;
const Uint8Property = require('./properties/uintProperties').Uint8Property;
const Int16Property = require('./properties/intProperties').Int16Property;
const Int8Property = require('./properties/intProperties').Int8Property;
...
const ValueMapProperty = require('./properties/valueMapProperty').ValueMapProperty;
const IndexedCollectionBaseProperty = require('./properties/indexedCollectionBaseProperty');

const Float32ArrayProperty = require('./properties/valueArrayProperty').Float32ArrayProperty;
const Float64ArrayProperty = require('./properties/valueArrayProperty').Float64ArrayProperty;
const Uint32ArrayProperty = require('./properties/valueArrayProperty').Uint32ArrayProperty;
const Int32ArrayProperty = require('./properties/valueArrayProperty').Int32ArrayProperty;
const Uint64ArrayProperty = require('./properties/valueArrayProperty').Uint64ArrayProperty;
const Int64ArrayProperty = require('./properties/valueArrayProperty').Int64ArrayProperty;
const Uint16ArrayProperty = require('./properties/valueArrayProperty').Uint16ArrayProperty;
const Int16ArrayProperty = require('./properties/valueArrayProperty').Int16ArrayProperty;
const Uint8ArrayProperty = require('./properties/valueArrayProperty').Uint8ArrayProperty;
const Int8ArrayProperty = require('./properties/valueArrayProperty').Int8ArrayProperty;
const StringArrayProperty = require('./properties/valueArrayProperty').StringArrayProperty;
const BoolArrayProperty = require('./properties/valueArrayProperty').BoolArrayProperty;
...
const Float64MapProperty = require('./properties/valueMapProperty').Float64MapProperty;
const Float32MapProperty = require('./properties/valueMapProperty').Float32MapProperty;
const Uint32MapProperty = require('./properties/valueMapProperty').Uint32MapProperty;
const Uint64MapProperty = require('./properties/valueMapProperty').Uint64MapProperty;
const Uint16MapProperty = require('./properties/valueMapProperty').Uint16MapProperty;
const Uint8MapProperty = require('./properties/valueMapProperty').Uint8MapProperty;
const Int32MapProperty = require('./properties/valueMapProperty').Int32MapProperty;
const Int64MapProperty = require('./properties/valueMapProperty').Int64MapProperty;
const Int16MapProperty = require('./properties/valueMapProperty').Int16MapProperty;
const Int8MapProperty = require('./properties/valueMapProperty').Int8MapProperty;
const StringMapProperty = require('./properties/valueMapProperty').StringMapProperty;
const ReferenceMapProperty = require('./properties/referenceMapProperty');
const BoolMapProperty = require('./properties/valueMapProperty').BoolMapProperty;
