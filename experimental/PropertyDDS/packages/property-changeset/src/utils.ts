 ...
 */
import { clone, cloneDeep as deepCopy, each, extend, find, forEach, isArray, isEmpty, isEqual, reduce } from "lodash";
...
export class TraversalContext {
    ...
    private _arrayLocalIndex: number | undefiend;
    ...
    protected _traverseChangeSetRecursivelyAsync(
        ...
        series([
            ...
            function(next: NextFn) {
                ...
                const {isEnum, typeid} = in_context.getSplitTypeID();
                    ...
                    series([
                        function(n2) {
                            try {
                                ...
                                this._traverseChangeSetRecursivelyAsync(in_preCallback, in_postCallback, in_context, n2);
                            } catch (ex) {
                                n2(ex);
                            }
                        },
